...
\usepackage{xltxtra}
\usepackage[bookmarks=false]{hyperref}  % 直接禁用 PDF 书签
...
% 定义图标命令，避免 hyperref 警告
\newcommand{\iconEducation}{{\color{CVBlue}\faGraduationCap}}
\newcommand{\iconUsers}{{\color{CVBlue}\faUsers}}
\newcommand{\iconCogs}{{\color{CVBlue}\faCogs}}
\newcommand{\iconList}{{\color{CVBlue}\faList}}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{志愿活动：} 浙江大学四星级志愿者，志愿时长达220+h
\end{itemize}


\section{{\color{CVBlue}\faUsers}\ 学生工作}
...
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    ...
    \item \textbf{统筹管理}：组织并执行 “跳脱出课本之外，徜徉于医海之中 —— 提升医学生沟通合作力与培育创新意识计划” \textbf{求是学院学生综合素质提升工程项目}，增强班级凝聚力、志愿服务意识与学习成绩。
\end{itemize}
...
\textbf{口腔医学本科生第一党支部正式党员} \hfill 2025.12 -- 至今

\section{{\color{CVBlue}\faCogs}\ 科研情况}
\textbf{SRTP校级项目：} γ分泌酶酶切LRP5形成LICD的作用机制研究 \hfill 2024.05 -- 2025.05
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
...
\end{itemize}
\projectsep
\textbf{生理科学实验结课项目：} 糖尿病对草酸钙肾结石严重程度的影响
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    \item \textbf{实验操作}：熟练掌握 \textbf{Olympus数字切片扫描仪VS200} 操作，利用 \textbf{Image J软件} 计算视野下阳性区域面积占视野总面积的百分比以表示草酸钙结晶肾内沉积的相对水平。
\end{itemize}

\section{{\color{CVBlue}\faList}\ 获奖情况} 
\begin{itemize}[nosep]
    \item \textbf{浙江大学一等奖学金} \hfill 2024.12
    \item \textbf{浙江省政府奖学金} \hfill 2023.12 /2024.12 /2025.12
    \item 浙江大学二等奖学金 \hfill 2023.12
    \item 浙江大学三等奖学金 \hfill 2025.12
    \item 浙江大学优秀学生 \hfill 2023.12 /2024.12
    \item 浙江大学校级优秀团员 \hfill 2023.6 /2024.6
    \item 浙江大学医学院优秀团干部 \hfill 2025.6
    \item \textbf{全国大学生英语竞赛（NECCS）C类二等奖} \hfill 2023.6
\end{itemize}
